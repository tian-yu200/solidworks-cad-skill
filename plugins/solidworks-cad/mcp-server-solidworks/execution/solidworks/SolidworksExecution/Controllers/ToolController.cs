    ...
    public class ToolController : ApiController
    {
        ...
        private ExecutionResponse Dispatch(ToolRequest request)
        {
            switch (request.Tool)
            {
                ...
                case "begin_undo_scope":       return _service.BeginUndoScope(request);
                case "commit_undo_scope":      return _service.CommitUndoScope(request);
                case "rollback_undo_scope":    return _service.RollbackUndoScope(request);
                ...
                case "insert_toolbox_component":
                                                return _service.InsertToolboxComponent(request);
                case "add_mate":               return _service.AddMateTool(request);
                case "create_exploded_view":   return _service.CreateExplodedView(request);
                case "create_detail_view":     return _service.CreateDetailView(request);
                case "import_model_annotations":
                                                return _service.ImportModelAnnotations(request);
                case "create_bom":             return _service.CreateBom(request);
                case "add_balloons":           return _service.AddBalloons(request);
                case "create_hole_table":      return _service.CreateHoleTable(request);
                case "check_drawing_standards":
                                                return _service.CheckDrawingStandards(request);
